...
export const Signup: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-black relative flex items-center justify-center overflow-hidden font-sans">
      {/* Background Effects */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_bottom_left,_var(--tw-gradient-stops))] from-royal-900/30 via-black to-black" />
      <div className="absolute top-[-20%] right-[-10%] w-[50%] h-[50%] bg-royal-600/10 rounded-full blur-[120px]" />
